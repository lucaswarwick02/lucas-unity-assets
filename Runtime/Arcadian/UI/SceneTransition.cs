...
namespace Arcadian.UI
{
    ...
    public class SceneTransition : MonoBehaviour
    {
        ...
        {
            var sceneTransition = new GameObject { name = "[Arcadian] Scene Transition" }.AddComponent<SceneTransition>();
        ...
        public IEnumerator Animation(Action changeScene, bool usePrefab)
        {
            ...
            GameObject prefab;
            if (usePrefab && (prefab = ArcadianAssetsSettings.GetOrCreate().sceneTransitionPrefab) != null)
            {
